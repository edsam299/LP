...
(function (factory) {
  ...
  Cropper.prototype = {
    ...
    clone: function () {
      ...
      this.$clone = $clone = $('<img' + getCrossOrigin(crossOrigin) +' id="imgOrigin"'+ ' src="' + (crossOriginUrl || url) + '">');
    ...
    build: function () {
      ...
      options.aspectRatio = NaN;//max(0, options.aspectRatio) || NaN; modify by ukit
    ...
    initPreview: function () {
      ...
      this.$clone2 = $clone2 = $('<img' + crossOrigin +' id="imgpreview"'+ ' src="' + url + '">');
